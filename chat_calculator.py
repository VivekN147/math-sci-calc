# main python program
response = ['Welcome to Python Chat Calculator', 'My name is Vivek',
            'Thanks for play with me. ', 'Sorry ,this is  beyond my ability']
...
# Enter your queries like
# add 2 and 3, multiply 3 and 4, say name